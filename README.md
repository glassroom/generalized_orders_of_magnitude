...
Formally, GOOMs are a set of mathematical objects, incorporating floating-point formats and logarithmic number systems as special cases. This implementation, among other things, enables you to operate on real numbers _far_ beyond the limits of conventional floating-point formats, for _effortless scaling and parallelization of high-dynamic-range computations_. Toy example:
